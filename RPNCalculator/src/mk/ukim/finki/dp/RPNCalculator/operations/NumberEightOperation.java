...
/**
 * Class for the operation of button8.
 */
public class NumberEightOperation extends AbstractBasicOperation {
    public NumberEightOperation(TextView txtDisplayValue, RPNCalculatorStack stack, RPNCalculatorState state) {
        super(txtDisplayValue, stack, state);
    }

    @Override
    public void defaultStateOperation() {
        DisplayValueHelper.addCharToDisplay(getTxtDisplayValue(), Constants.EIGHT);
    }

    @Override
    public void programStateOperation() {
        ProgramManipulationHandler.addProgramCharacter(Constants.EIGHT);
        DisplayValueHelper.addCharToDisplay(getTxtDisplayValue(), Constants.EIGHT);
    }
    ...
    public void storeStateOperation() {
        ...
        int index = MathOperationsHelper.parseStringToInteger(Constants.EIGHT);
