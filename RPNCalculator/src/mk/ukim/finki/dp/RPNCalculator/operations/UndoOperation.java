...
/**
 * Class for the operation of buttonUndo.
 */
public class UndoOperation extends AbstractBasicOperation {
    public UndoOperation(TextView txtDisplayValue, RPNCalculatorStack stack, RPNCalculatorState state) {
