...
/**
 * Class for the operation of buttonRedo.
 */
public class RedoOperation extends AbstractBasicOperation {
    public RedoOperation(TextView txtDisplayValue, RPNCalculatorStack stack, RPNCalculatorState state) {
