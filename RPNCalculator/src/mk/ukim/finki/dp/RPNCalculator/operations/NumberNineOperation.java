...
/**
 * Class for the operation of button9.
 */
public class NumberNineOperation extends AbstractBasicOperation {
    public NumberNineOperation(TextView txtDisplayValue, RPNCalculatorStack stack, RPNCalculatorState state) {
        super(txtDisplayValue, stack, state);
    }

    @Override
    public void defaultStateOperation() {
        DisplayValueHelper.addCharToDisplay(getTxtDisplayValue(), Constants.NINE);
    }

    @Override
    public void programStateOperation() {
        ProgramManipulationHandler.addProgramCharacter(Constants.NINE);
        DisplayValueHelper.addCharToDisplay(getTxtDisplayValue(), Constants.NINE);
    }
    ...
    public void storeStateOperation() {
        ...
        int index = MathOperationsHelper.parseStringToInteger(Constants.NINE);
