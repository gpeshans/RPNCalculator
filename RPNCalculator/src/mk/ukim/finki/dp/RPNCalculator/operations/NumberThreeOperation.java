...
/**
 * Class for the operation of button3.
 */
public class NumberThreeOperation extends AbstractBasicOperation {
    public NumberThreeOperation(TextView txtDisplayValue, RPNCalculatorStack stack, RPNCalculatorState state) {
        super(txtDisplayValue, stack, state);
    }

    @Override
    public void defaultStateOperation() {
        DisplayValueHelper.addCharToDisplay(getTxtDisplayValue(), Constants.THREE);
    }

    @Override
    public void programStateOperation() {
        ProgramManipulationHandler.addProgramCharacter(Constants.THREE);
        DisplayValueHelper.addCharToDisplay(getTxtDisplayValue(), Constants.THREE);
    }
    ...
    public void storeStateOperation() {
        ...
        int index = MathOperationsHelper.parseStringToInteger(Constants.THREE);
