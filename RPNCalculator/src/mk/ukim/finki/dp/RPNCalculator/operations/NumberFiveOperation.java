...
/**
 * * Class for the operation of button5.
 */
public class NumberFiveOperation extends AbstractBasicOperation {
    public NumberFiveOperation(TextView txtDisplayValue, RPNCalculatorStack stack, RPNCalculatorState state) {
        super(txtDisplayValue, stack, state);
    }

    @Override
    public void defaultStateOperation() {
        DisplayValueHelper.addCharToDisplay(getTxtDisplayValue(), Constants.FIVE);
    }

    @Override
    public void programStateOperation() {
        ProgramManipulationHandler.addProgramCharacter(Constants.FIVE);
        DisplayValueHelper.addCharToDisplay(getTxtDisplayValue(), Constants.FIVE);
    }
    ...
    public void storeStateOperation() {
        ...
        int index = MathOperationsHelper.parseStringToInteger(Constants.FIVE);
