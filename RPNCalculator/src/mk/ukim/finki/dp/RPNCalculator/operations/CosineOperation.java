...
/**
 * Class for the operation of buttonCosine.
 */
public class CosineOperation extends AbstractBasicOperation {
    public CosineOperation(TextView txtDisplayValue, RPNCalculatorStack stack, RPNCalculatorState state) {
