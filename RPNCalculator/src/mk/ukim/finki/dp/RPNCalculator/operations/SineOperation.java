...
import mk.ukim.finki.dp.RPNCalculator.mathoperations.ArcsineOperationImpl;
import mk.ukim.finki.dp.RPNCalculator.mathoperations.MathTrigonometricOperation;
import mk.ukim.finki.dp.RPNCalculator.mathoperations.SineOperationImpl;
...
/**
 * Class for the operation of buttonSine.
 */
public class SineOperation extends AbstractBasicOperation {
    public SineOperation(TextView txtDisplayValue, RPNCalculatorStack stack, RPNCalculatorState state) {
